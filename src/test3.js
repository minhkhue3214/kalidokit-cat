...
// import * as P from './PixiJS_Renderer/pixi.min.js'
// import { Live2DModel } from 'pixi-live2d-display/dist/cubism2';
...
const startCamera = () => {
  ...
  return (
    <div className="App">
      ...
      <video ref={video2Ref} playsInline width="520" height="540" autoPlay src="https://media.geeksforgeeks.org/wp-content/uploads/20190616234019/Canvas.move_.mp4"></video>
